...
async function init() {
    ...
    canvas.onmousemove = function (d) {
        var mpos = [-1 + d.layerX / canvas.width, 0.5 - d.layerY / canvas.width]
...
document.addEventListener('scroll',()=>{
  document.querySelector('#home').style.filter = 'blur('+window.scrollY/50+'px)';
  document.querySelector('#second').style.filter = 'blur('+window.scrollY/500+'px)';
})
*/